...
class DashboardController extends Controller
{
    ...
    //     $now = date('Y-m-d');
    //     $lastTagihan = $pemasangan->tanggal_generate_terakhir;
    //     $nextTagihan = $pemasangan->tanggal_generate;
    //     $next = false;
    //     $rs_tagihan = [];
    //     while ($next == false) {
    ...
    //         }
    //         $pemasangan->tanggal_generate = $tanggalTagihan;
    ...
    //             $pemasangan->tanggal_generate_terakhir = $tanggalTagihan;
    ...
    //         $pemasangan->tanggal_generate = $tanggal_generate;
    //         $pemasangan->tanggal_generate_terakhir = $request->tanggal_pemasangan;
    //     }
    //     if(count($rs_tagihan)) {
